...
team_map = {
    ...
    "47": Team.createTeam("47", "Howard", "Bison", "Howard", "HOW", "9e0b0e", "ffffff"),
    "85": Team.createTeam(
    ...
    "254": Team.createTeam("254", "Utah", "Utes", "Utah", "UTAH", "890012", "ffffff"),
    "238": Team.createTeam(
    ...
    "43": Team.createTeam("43", "Yale", "Bulldogs", "Yale", "YALE", "004a81", "ffffff"),
