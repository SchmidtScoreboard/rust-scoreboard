...
if __name__ == '__main__':
    ...
    def get_teams(filename):
        ...
        with open(filename) as f:
            ...
            return { team["id"] : Team.createTeam(int(team["id"]),
            team["shortDisplayName"], team["abbreviation"], team["color"],
            team.get("alternateColor", "000000")) for team in [team["team"] for team in
                json_teams] }
